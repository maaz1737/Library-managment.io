    ...
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #e3f2fd;">
        ...
        <div class="dropdown mx-3">
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                ...
                <li><a class="dropdown-item" href="anc.php">Add New Category</a></li>
        ...
        <div class="dropdown mx-3">
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                ...
                <li><a class="dropdown-item" href="viewauthors.php">Add New Authors</a></li>
        ...
        <div class="mx-3">
            <nav class="">
                <a class="text-dark" href="issuebooks.php">Issue Book</a>
            </nav>
    ...
    <div class="row">
        <div class="col-md-3">
            <div class="card bg-light" style="width: 300px;">
                ...
                <div class="card-body">
                    <p class="card-text">Numbers of total users:<?php echo getusercount();   ?></p>
                    <a class="btn btn-danger" href="reguser.php">View Registered Users</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="card bg-light" style="width: 300px;">
                ...
                <div class="card-body">
                    <p class="card-text">Numbers of Available Books:<?php echo  getbookcount(); ?></p>
                    <a class="btn btn-primary" href="regbook.php">View Available Books</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="card bg-light" style="width: 300px;">
                <div class="card-header ">
                    Registered Catergory
                </div>
                <div class="card-body">
                    <p class="card-text">Numbers of Books Category:<?php echo getcatergorycount();   ?></p>
                    <a class="btn btn-danger" href="regcat.php">View Category</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="card bg-light" style="width: 300px;">
                ...
                <div class="card-body">
                    <p class="card-text">Numbers of Registered Authors:<?php echo getauthorscount(); ?></p>
                    <a class="btn btn-primary" href="regaut.php">View Authors</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3 my-3">
            <div class="card bg-light" style="width: 300px;">
                ...
                <div class="card-body">
                    <p class="card-text">Numbers of Issued Books:<?php  echo getissuecount();      ?></p>
                    <a class="btn btn-info" href="vib.php">View Books</a>
                </div>
            </div>
        </div>
